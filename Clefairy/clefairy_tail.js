export function generateClefairy_Tail(radius, tubeRadius, height, stacks, steps) {
    ...
    // Atur Shape
    const tailLength = radius * 0.05;   // panjang yang mau dilurusin
    const baseStraight = 0.25;          // proporsi panjang yang mau dilurusin
    const turns = 1.5;                  // spiralnya mau berapa banyak
    const taper = 0.1;                  // eberapa kecil spiral ditengah yang dimau
    const verticalLift = 0.35;          // buat ada gap antara spiral layer

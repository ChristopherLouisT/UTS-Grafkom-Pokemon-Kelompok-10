export function generateCleffa_Swirl(radius, tubeRadius, height, stacks, steps) {
    let vertices = [];
    let faces = [];

    // --- Shape configuration ---
    const tailLength = radius * 0.9;// straight portion before spiral
    const baseStraight = 0.0;      // proportion of total length that stays straight
    const turns = 1;              // total number of spiral turns
    const taper = 0.5;           // how much smaller the spiral gets at the center
